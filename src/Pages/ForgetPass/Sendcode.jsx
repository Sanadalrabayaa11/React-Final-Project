...
function ForgetPass() {
  ...
  return (
   ...
   <svg xmlns="http://www.w3.org/2000/svg" width={60} height={60} fill="currentColor" className="bi bi-lock text-info" viewBox="0 0 16 16">
  <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2m3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2M5 8h6a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1" />
      ...
      <label className="text-center fw-bold fs-3 me-3">
              ...
              <input className="bg-info border border-black border-3 w-auto"
                type="email"
                value={email}
                name="email"
              ...
              <div className="col-12 mb-4">
        <button type="submit" className="btn btn-outline-info" disabled={loader}>
