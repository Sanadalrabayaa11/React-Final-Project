...
function Login() {
  ...
  return (
   ...
   <svg xmlns="http://www.w3.org/2000/svg" width={80} height={50} fill="currentColor" className="bi bi-person-bounding-box text-info" viewBox="0 0 16 16">
 ...
 <div className="row mb-3 ">
      ...
      <div className="col-12 mb-4">
            ...
            <p className="fs-5 text-capitalize fw-bolder  ">
              <Link className="text-decoration-none" to="/Register">Create new account ?</Link>
            </p>
            <p className="fs-5 text-capitalize fw-bolder text-decoration-none ">
