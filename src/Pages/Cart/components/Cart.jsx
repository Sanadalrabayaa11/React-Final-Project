...
function Cart() {
  ...
  function handleCheckoutClick(cartItems) {
    toast.success(
      "All my information is correct. Complete the purchase process",
      {
                ...
                <div className="row g-5">
                  <div className="col-lg-9">
                    <div className="p-0">
                      <div className="d-flex flex-column flex-wrap">
                        <h1 className="fw-bold mb-5 text-black text-center">
                          Shopping Cart
                          <svg
                            ...
                            <>
                              {cartItems.length === 0 ? (
                                <div className="text-center text-danger fs-5 border-bottom border-danger text-capitalize fw-bold">
                                  ...
                                  <span>
                                    Go to browsing and then return to the
                                    shopping cart
                                  </span>
                                </div>
                              ) : (
                                    ...
                                    <table className="table table-bordered table-hover border border-info border-3">
                                      <thead>
                                        <tr className="text-center">
                                          <th className="border border-info border-5">
                                            Image
                                          </th>
                                          <th className="border border-info border-5">
                                            Name
                  ...
                  <div className="col-lg-3 p-0 ">
                    <div className="p-5 bg-primary-subtle mt-5">
                      <h3 className="fw-lg-bold mb-5 mt-2 pt-1 text-center ">
                        Summary
                      </h3>
                      <hr className="my-4" />
