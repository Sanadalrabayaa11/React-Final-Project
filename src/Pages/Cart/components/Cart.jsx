      ...
      <div className="row justify-content-center align-items-center h-100">
        <div className="col-lg-12">
          <div className="card border border-info" style={{ borderRadius: "50px" }}>
            <div className="card-body p-xl-5 p-5">
              <div className="row g-5">
                <div className="col-lg-9">
                  <div className="p-0">
                    <div className="d-flex flex-column flex-wrap">
                      <h1 className="fw-bold mb-5 text-black text-center">Shopping Cart
                        <svg xmlns="http://www.w3.org/2000/svg" width={80} height={40} fill="currentColor" className="bi bi-basket text-info" viewBox="0 0 16 16">
                            ...
                            {cartItems.length === 0 ? (
                              ...
                              <>
                                <div className="table-responsive">
                                  <table className="table table-bordered table-hover border border-info border-3">
                                    <thead>
                                    ...
                                    <tbody>
                                      {cartItems.map((item) => (
                                        <tr key={item.details._id} className="text-center">
                                          ...
                                          <td className="border border-info border-2">${item.details.name}</td>
                                          <td className="border border-info border-2">${item.details.price}</td>
                                        </tr>
                                      ))}
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      {cartItems.map((item) => (
                                        <tr key={item.details._id} className="text-center">
                                          ...
                                          <td className="border border-info border-2 text-center">
                                            <button
                                              className="btn btn-sm btn-outline-danger"
                                              onClick={() => handleRemoveItem(item.details._id)}
                                            >
                ...
                <div className="col-lg-3 p-0 ">
                  <div className="p-5 bg-primary-subtle mt-5">
                    <h3 className="fw-lg-bold mb-5 mt-2 pt-1 text-center ">Summary</h3>
                    <hr className="my-4" />
